...
<p align="center">
  <b>
    <tt>deb-get-extras</tt> is a repository with more 3rd party apt repositories and PPAs for deb-get based in "Custom User Includes".
  </b>
</p>

## Introduction

`deb-get-extra` is a repository with additional repositories for deb-get that is not part of deb-get package lists or yet not.
...
### Softwares available in `deb-get`
...
### How to contribute and add more softwares in this repository
Open a new issue with this estructure:
```
function deb_example() {
    APT_KEY_URL="https://deb.example.org/package-name/file.gpg"
    APT_LIST_NAME="example"
    APT_REPO_URL="deb http://deb.example.org/dist/ dist main"
    PRETTY_NAME="Name package"
    WEBSITE="https://github.com/author/project-name"
    SUMMARY="Few description about the package/project"
}
```
